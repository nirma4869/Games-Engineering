...
public class RoboCM : MonoBehaviour
{
    [SerializeField] public Robo robo;
    ...
    void Update()
    {
        ...
        List<PathNode> path = pathfinding.FindPath((int)robo.transform.position.x, (int)robo.transform.position.y, x, y);
    }
}
